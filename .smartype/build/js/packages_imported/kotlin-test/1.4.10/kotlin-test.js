;(function(root, factory) {
  if (typeof define === "function" && define.amd)
    ...
    if (typeof kotlin === "undefined") {
      throw new Error(
        "Error loading module 'kotlin-test'. Its dependency 'kotlin' was not found. Please, check whether 'kotlin' is loaded prior to 'kotlin-test'."
      )
    }
    root["kotlin-test"] = factory(
      typeof this["kotlin-test"] === "undefined" ? {} : this["kotlin-test"],
      kotlin
    )
  }
  ...
  var Throwable = Error
  var IllegalArgumentException_init =
  ...
  function assertTrue_0(actual, message) {
    if (message === void 0) message = null
    return get_asserter().assertTrue_4mavae$(
      message != null ? message : "Expected value to be true.",
      actual
    )
  }
  ...
  function assertFalse_0(actual, message) {
    if (message === void 0) message = null
    return get_asserter().assertTrue_4mavae$(
      message != null ? message : "Expected value to be false.",
      !actual
    )
  }
  ...
  var assertFails = defineInlineFunction(
    "kotlin-test.kotlin.test.assertFails_o14v8n$",
  ...
  var assertFails_0 = defineInlineFunction(
    "kotlin-test.kotlin.test.assertFails_9bodf6$",
    wrapFunction(function() {
      var checkResultIsFailure = _.kotlin.test.checkResultIsFailure_8v9b5x$
      var Result = Kotlin.kotlin.Result
      var Throwable = Error
  ...
  function checkResultIsFailure(message, blockResult) {
    ...
    if (exception == null) {
      ;(tmp$ = blockResult.value) == null ||
        Kotlin.isType(tmp$, Any) ||
        throwCCE()
      tmp$_0 = get_asserter().fail_pdl1vj$(
  ...
  var assertFailsWith = defineInlineFunction(
    "kotlin-test.kotlin.test.assertFailsWith_cnau6l$",
    wrapFunction(function() {
  ...
  var assertFailsWith_0 = defineInlineFunction(
    "kotlin-test.kotlin.test.assertFailsWith_jbbixx$",
    wrapFunction(function() {
      var checkResultIsFailure = _.kotlin.test.checkResultIsFailure_3e4uyv$
      var Result = Kotlin.kotlin.Result
      var Throwable = Error
  ...
  var assertFailsWith_1 = defineInlineFunction(
    "kotlin-test.kotlin.test.assertFailsWith_l9oqa2$",
    wrapFunction(function() {
      var checkResultIsFailure = _.kotlin.test.checkResultIsFailure_3e4uyv$
      var Result = Kotlin.kotlin.Result
      var Throwable = Error
  ...
  function Asserter$assertEquals$lambda(
    closure$message,
    closure$expected,
    closure$actual
  ) {
    return function() {
      return (
        messagePrefix(closure$message) +
        ("Expected <" +
          toString(closure$expected) +
          ">, actual <" +
          toString(closure$actual) +
          ">.")
      )
    }
  }
  Asserter.prototype.assertEquals_lzc6tz$ = function(
    message,
    expected,
    actual
  ) {
    this.assertTrue_o10pc4$(
  ...
  function Asserter$assertNotEquals$lambda(closure$message, closure$actual) {
    return function() {
      return (
        messagePrefix(closure$message) +
        ("Illegal value: <" + toString(closure$actual) + ">.")
      )
    }
  }
  Asserter.prototype.assertNotEquals_lzc6tz$ = function(
    message,
    illegal,
    actual
  ) {
    this.assertTrue_o10pc4$(
      Asserter$assertNotEquals$lambda(message, actual),
      !equals(actual, illegal)
    )
  }
  function Asserter$assertSame$lambda(
    closure$message,
    closure$expected,
    closure$actual
  ) {
  ...
  function Asserter$assertNotSame$lambda(closure$message, closure$actual) {
    return function() {
      return (
        messagePrefix(closure$message) +
        ("Expected not same as <" + toString(closure$actual) + ">.")
      )
    }
  }
  Asserter.prototype.assertNotSame_lzc6tz$ = function(
    message,
    illegal,
    actual
  ) {
    this.assertTrue_o10pc4$(
      Asserter$assertNotSame$lambda(message, actual),
      actual !== illegal
    )
  }
  ...
  Asserter.prototype.assertNull_67rc9h$ = function(message, actual) {
    this.assertTrue_o10pc4$(
      Asserter$assertNull$lambda(message, actual),
      actual == null
    )
  }
  ...
  Asserter.prototype.assertNotNull_67rc9h$ = function(message, actual) {
    this.assertTrue_o10pc4$(
      Asserter$assertNotNull$lambda(message),
      actual != null
    )
  }
  Asserter.$metadata$ = {
  ...
  DefaultAsserter.prototype.fail_pdl1vj$ = function(message) {
    if (message == null) throw AssertionError_init()
    else throw AssertionError_init_0(message)
  }
  ...
  DefaultJsAsserter.prototype.assertEquals_lzc6tz$ = function(
    message,
    expected,
    actual
  ) {
    this.e_0 = expected
    this.a_0 = actual
    Asserter.prototype.assertEquals_lzc6tz$.call(
      this,
      message,
      expected,
      actual
  ...
  DefaultJsAsserter.prototype.assertNotEquals_lzc6tz$ = function(
    message,
    illegal,
    actual
  ) {
    this.e_0 = illegal
    this.a_0 = actual
    Asserter.prototype.assertNotEquals_lzc6tz$.call(
      this,
      message,
      illegal,
      actual
  ...
  DefaultJsAsserter.prototype.assertSame_lzc6tz$ = function(
    message,
    expected,
    actual
  ) {
  ...
  DefaultJsAsserter.prototype.assertNotSame_lzc6tz$ = function(
    message,
    illegal,
    actual
  ) {
    this.e_0 = illegal
    this.a_0 = actual
    Asserter.prototype.assertNotSame_lzc6tz$.call(
      this,
      message,
      illegal,
      actual
  ...
  DefaultJsAsserter.prototype.assertNotNull_67rc9h$ = function(
    message,
    actual
  ) {
    this.a_0 = actual
  ...
  DefaultJsAsserter.prototype.assertTrue_o10pc4$ = function(
    lazyMessage,
    actual
  ) {
    if (!actual) {
      ...
      this.invokeHook_0(
        false,
        DefaultJsAsserter$failWithMessage$lambda(message)
      )
  ...
  DefaultJsAsserter.prototype.assertTrue_4mavae$ = function(message, actual) {
    this.assertTrue_o10pc4$(
      DefaultJsAsserter$assertTrue$lambda(message),
      actual
    )
  }
  ...
  DefaultJsAsserter.prototype.fail_wspj0f$ = function(message, cause) {
    ...
    this.invokeHook_0(
      false,
      DefaultJsAsserter$failWithMessage$lambda(message_0)
    )
  ...
  function DefaultJsAsserter$invokeHook$ObjectLiteral(
    closure$result,
    closure$lazyMessage
  ) {
  ...
  Object.defineProperty(
    DefaultJsAsserter$invokeHook$ObjectLiteral.prototype,
    "result",
    {
      configurable: true,
      get: function() {
  ...
  DefaultJsAsserter.prototype.invokeHook_0 = function(result, lazyMessage) {
    try {
      assertHook(
        new DefaultJsAsserter$invokeHook$ObjectLiteral(result, lazyMessage)
      )
    } finally {
      this.e_0 = undefined
      this.a_0 = undefined
  ...
  var AssertionErrorWithCause = defineInlineFunction(
    "kotlin-test.kotlin.test.AssertionErrorWithCause_6umzry$",
    wrapFunction(function() {
      var AssertionError_init = Kotlin.kotlin.AssertionError
  ...
  function checkResultIsFailure_0(exceptionClass, message, blockResult) {
    ...
    if (exception == null) {
      ...
      tmp$_0 = get_asserter().fail_pdl1vj$(
        messagePrefix(message) +
          ("Expected an exception of " +
            exceptionClass +
            " to be thrown, but was completed successfully.")
      )
    } else {
      var tmp$_1
      if (exceptionClass.isInstance_s8jyv4$(exception)) {
        return Kotlin.isType((tmp$_1 = exception), Throwable)
          ? tmp$_1
          : throwCCE()
      }
      tmp$_0 = get_asserter().fail_wspj0f$(
        messagePrefix(message) +
          ("Expected an exception of " +
            exceptionClass +
            " to be thrown, but was " +
            exception),
        exception
      )
    }
    ...
    if (typeof adapter === "string") {
      ...
      if (tmp$_0 == null)
        throw IllegalArgumentException_init(
          "Unsupported test framework adapter: '" + adapter.toString() + "'"
        )
    } else {
  ...
  function detectAdapter() {
    if (isQUnit()) return new QUnitAdapter()
    else if (isJasmine()) return new JasmineLikeAdapter()
    else return new BareAdapter()
  }
  var NAME_TO_ADAPTER
  ...
  function QUnitAdapter$wrapTest$lambda$lambda(
    closure$assertionsHappened,
    closure$assert
  ) {
  ...
  function QUnitAdapter$wrapTest$lambda(closure$testFn) {
    return function(assert) {
      ...
      assertHook = QUnitAdapter$wrapTest$lambda$lambda(
        assertionsHappened,
        assert
      )
  ...
  DefaultAsserter.prototype.assertTrue_o10pc4$ =
    Asserter.prototype.assertTrue_o10pc4$
  DefaultAsserter.prototype.assertTrue_4mavae$ =
    Asserter.prototype.assertTrue_4mavae$
  DefaultAsserter.prototype.assertEquals_lzc6tz$ =
    Asserter.prototype.assertEquals_lzc6tz$
  DefaultAsserter.prototype.assertNotEquals_lzc6tz$ =
    Asserter.prototype.assertNotEquals_lzc6tz$
  DefaultAsserter.prototype.assertSame_lzc6tz$ =
    Asserter.prototype.assertSame_lzc6tz$
  DefaultAsserter.prototype.assertNotSame_lzc6tz$ =
    Asserter.prototype.assertNotSame_lzc6tz$
  DefaultAsserter.prototype.assertNull_67rc9h$ =
    Asserter.prototype.assertNull_67rc9h$
  DefaultAsserter.prototype.assertNotNull_67rc9h$ =
    Asserter.prototype.assertNotNull_67rc9h$
  _asserter = null
  assertHook = assertHook$lambda
  currentAdapter = null
  NAME_TO_ADAPTER = mapOf([
    to(
      "qunit",
      getCallableRef("QUnitAdapter", function() {
        return new QUnitAdapter()
      })
    ),
    to(
      "jasmine",
      getCallableRef("JasmineLikeAdapter", function() {
    ...
    to(
      "auto",
      getCallableRef("detectAdapter", function() {
